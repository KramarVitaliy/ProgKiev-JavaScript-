...
$address="kramarenko.199@gmail.com";
// текст письма 
$note_phone1="Тема : $urok \r\nИмя : $name1 \r\n Email : $email1 \r\n Дополнительная информация : $phone1";

if (isset($name1)  &&  isset ($sab) ) {
mail($address,$urok,$note_phone1,"Content-type:phone1/plain; windows-1251"); 
